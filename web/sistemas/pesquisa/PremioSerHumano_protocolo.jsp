        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <br><br><br>
                    <h2 class="intro-text text-center">Obrigado pela sua participação!
                        <br>
                    </h2>
                    <h2 class="intro-text text-center">Segue o numero de protocolo de registro de sua pesquisa:
                    </h2>
                    <h2 class="intro-text text-center"><font color="red">${mensagem}</font>
                    </h2>
                    <br><br><br>
                </div>
            </div>
