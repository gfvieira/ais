...
<html lang="pt-br">
    <head>
        ...
        <title>SIG-BASE || Departamento de Apoio BH-50</title>
        ...
        <section id="container" >
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <header class="header black-bg">
                ...
                <!--logo start-->
                <a href="index.html" class="logo"><b><%out.print(usuario.getPost());%> - <%out.print(usuario.getGuerra());%></b></a>
                <!--logo end-->
                <div class="top-menu">
                            ...
                            <table class="table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fa fa-angle-double-right text-center"></i> Ramal</th>
                                ...
                                <tbody>
                                        ...
                                        <%} else {%>
                                        <td><%out.print(oficina.getStatus());%></td>
                                        <%}%>
                                        <%}%>
                                    </tr>
                                    <% }%>
