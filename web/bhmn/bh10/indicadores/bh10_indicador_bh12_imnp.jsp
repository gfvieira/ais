                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-12 | Indicador de Eficácia da Mapoteca por pedido (IMNP) </h3>
                                    <h5 class="text-center" style="color: black;font-size: 10px;">(Melhores práticas – Acima de 95%)</h5>
                                </div>
                                <div class="custom-bar-chart">
                                    ...
                                    <div class="bar" style="width: 6%; margin: 0px 4%; margin-left: 50px;">
                                        ...
                                        <div class="bar" style="width: 6%; margin: 0px 4%;">
                                            <%}
                                                if (ind.getValue() >= 95) {%>
                                            <div class="title" style="color: black; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(ind.getAno());%></div>
                                    ...
                                    <thead>
                                        <tr>
                                            <%for (Indicador_bh10_model ind : indarray) {
                                                    ...
                                                    if (ind.getValue() >= 95) {%>  
                                            <th style="color: black; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(ind.getAno());%></th>
                                                <%} else {%>
                                            <th style="color: black; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(ind.getAno());%></th>
                                                <%}
                                                }%>
