                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-12 | Indicador de Economicidade da Impressão por Demanda (IID) </h3>
                                    <h5 class="text-center" style="color: black;font-size: 10px;">(Melhores práticas – abaixo de 5%)</h5>
                                </div>
                                <div class="custom-bar-chart">
                                    ...
                                    <div class="bar" style="width: 6%; margin: 0px 4%; margin-left: 50px;">
                                        ...
                                        <div class="bar" style="width: 6%; margin: 0px 4%;">
                                            <%}
                                                if (ind.getValue() <= 5 && ind.getValue() > 0) {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(ind.getAno());%></div>
                                            <div class="value tooltips" data-original-title="<%out.print(ind.getValue());%>" data-toggle="tooltip" data-placement="top" style="background: #006400"><%out.print((ind.getValue()*10));%>%</div>
                                            <%} else {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(ind.getAno());%></div>
                                            <div class="value tooltips" data-original-title="<%out.print(ind.getValue());%>" data-toggle="tooltip" data-placement="top" style="background: #ff3333"><%out.print((ind.getValue()*10));%>%</div>
                                            <%}%>
                                        </div>
                                        <% }%>
                                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <%for (Indicador_bh10_model ind : indarray) {
                                                         if (ind.getValue() <= 5 && ind.getValue() > 0) {%>
                                            <td style="color: black;"><%out.print(ind.getReal());%></td>
                                            <%} else {%>
                                            <td style="color: black;"><%out.print(ind.getReal());%></td>
                                            <%}
                                                        }%>
