                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-33 | Indicador de Confecção de Crachás de Visitantes (ICCv) </h3>
                                    <h5 class="text-center" style="color: black;font-size: 10px;">(Melhores práticas – Abaixo de 3%)</h5>
                                </div>
                                <div class="custom-bar-chart">
                                    ...
                                    <%for (Indicador_model_anual sate : sateAnual) {
                                            if (sate.getOficina().equals("VISITANTE")) {
                                                String mesInd = "";
                                    ...
                                    <div class="bar" style="width: 6%; margin: 0px 4%; margin-left: 50px;">
                                        ...
                                        <div class="bar" style="width: 6%; margin: 0px 4%;">
                                            <%}if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) <= 0.03) {%>
                                            ...
                                            <%}else if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) > 0.03 && sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) < 0.06 ) {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3 style="color: black;">Nº de crachás extraviados / Nº de crachás confeccionados</h3>
                                </div>
