                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>CHaPA | Indicador de Atendimento de Pedidos de Serviços (IAPS) </h3>
                                    <h5 class="text-center" style="color: black;font-size: 10px;">(Melhores práticas – Acima de 75%)</h5>
                                </div>
                                <div class="custom-bar-chart">
                                    ...
                                    <%for (Indicador_model_anual sate : sateAnual) {
                                            if (sate.getOficina().equals("CHAPA")) {
                                                String mesInd = "";
                                    ...
                                    <div class="bar" style="width: 6%; margin: 0px 4%; margin-left: 50px;">
                                        ...
                                        <div class="bar" style="width: 6%; margin: 0px 4%;">
                                            <%}if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) >= 0.75) {%>
                                            ...
                                            <%}else if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) >= 0.5 && sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) < 0.75 ) {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3 style="color: black;">nº de solicitações respondidas / nº de solicitações de reparo de serviço</h3>
                                </div>
