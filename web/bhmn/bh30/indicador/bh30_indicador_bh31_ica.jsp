                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-31 | Indicador de Cumprimento de Adestramento (ICA) </h3>
                                ...
                                <div class="custom-bar-chart">
                                    ...
                                    <%for (Indicador_model_anual sate : sateAnual) {
                                            if (sate.getOficina().equals("ADESTRAMENTO")) {
                                                String mesInd = "";
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3 style="color: black;">Adestramento cumpridos  / Adestramento programados</h3>
                                </div>
                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="col-lg-6 main-chart">
                                <div class="content-panel">		
                                    <!--CUSTOM CHART START -->
                                    <div class="border-head">
                                        <h3>BH-31 | Comparativo de quantitativo <br> de cursos e cursados de 2012 a 2015 </h3>
                                    ...
                                    <div class="custom-bar-chart">
                                        ...
                                        <div class="bar" style="margin: 0px 8%;">
                                            ...
                                            <div class="value tooltips" data-original-title="<%out.print(39.13);%>" data-toggle="tooltip" data-placement="top" style="background: blue"><%out.print(39.13);%>%</div>
                                        </div>
                                        <div class="bar" style="margin: 0px 8%;">
                                            <div class="title">2014</div>
                                            <div class="value tooltips" data-original-title="<%out.print(43.29);%>" data-toggle="tooltip" data-placement="top" style="background: blue"><%out.print(43.29);%>%</div>
                                        </div>
                                        <div class="bar" style="margin: 0px 8%;">
                                            <div class="title">2013</div>
                                            <div class="value tooltips" data-original-title="<%out.print(43.56);%>" data-toggle="tooltip" data-placement="top" style="background: blue"><%out.print(43.56);%>%</div>
                                        </div>
                                        <div class="bar" style="margin: 0px 8%;">
                                            <div class="title">2012</div>
                                            <div class="value tooltips" data-original-title="<%out.print(40.18);%>" data-toggle="tooltip" data-placement="top" style="background: blue"><%out.print(40.18);%>%</div>
                                        </div>
                                    </div>	
                                </div>
                            </div>
