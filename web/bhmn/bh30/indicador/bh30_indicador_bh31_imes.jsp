                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-31 | Indicador de Militares para Escala de Serviço (IMES) </h3>
                                ...
                                <div class="custom-bar-chart">
                                    ...
                                    <%for (Indicador_model_anual sate : sateAnual) {
                                            if (sate.getOficina().equals("DETALHE2")) {
                                                String mesInd = "";
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3  style="color: black;">Nº de militares cedidos  / Nº de militares a serem cedidos</h3>
                                </div>
