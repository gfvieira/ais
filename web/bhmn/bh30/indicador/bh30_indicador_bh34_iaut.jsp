                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    ...
                                    <h5 class="text-center">(Melhores práticas – Acima de 90%)</h5>
                                    <h5 class="text-center">(Boas práticas – Entre 70% a 90%)</h5>
                                </div>
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3 style="color: black;">Numeros de pedidos Fechado / Numeros total de pedidos </h3>
                                </div>
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3 style="color: black;">INDICADOR DA UTILIZAÇÃO DO SISTEMA DE SOM </h3>
                                    <h5 style="color: black;">Numeros de pedidos Fechado / Numeros total de pedidos </h5>
                                </div>
                                <table class="table table-hover">
                                    <hr>
                                    <thead>
