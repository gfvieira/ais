                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-32 | Coeficiente de Autossuficiência Odontológico (CASOD) </h3>
                                ...
                                <div class="custom-bar-chart">
                                    ...
                                    <%for (Indicador_model_anual sate : sateAnual) {
                                            if (sate.getOficina().equals("ODONTO")) {
                                                String mesInd = "";
                                    ...
                                    <div class="bar" style="width: 6%; margin: 0px 4%; margin-left: 50px;">
                                        ...
                                        <div class="bar" style="width: 6%; margin: 0px 4%;">
                                            ...
                                            <%}else if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) > 0.1 && sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) <= 0.40 ) {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                            ...
                            <div class="col-lg-12 main-chart">
                                <div class="border-head">
                                    <h3  style="color: black;">Encaminhados OCM  / Total de atendimentos</h3>
                                </div>
