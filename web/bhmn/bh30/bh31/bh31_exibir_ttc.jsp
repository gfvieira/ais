...
<%Servidor_model servidor = (Servidor_model) request.getAttribute("ttc");
    ArrayList<Servidor_movi> servidorarray = (ArrayList<Servidor_movi>) request.getAttribute("ttcarray");
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form" action="ExibePessoal.jsp" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label" style="text-align: right;"><font color="black"><b>Posto/Graduação:</b></font></label>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-2">
                                            <p class="form-control-static" style="text-align: left;"><%out.println(servidor.getQuadro());%></p>
                                        </div>                                            
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2"> 
                                            <p class="form-control-static" style="text-align: left;"><%out.println(servidor.getGuerra());%></p>
                                        </div> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <p class="form-control-static" style="text-align: left;"><%out.println(servidor.getEsp());%></p>
                                        </div>
                        ...
                        <div class="col-md-12 mt" style="margin-top: 5px">
                            <div class="form-panel">
                                ...
                                <form  class="col-sm-2 control-label" action="ExibePessoal.jsp" method="post">
                                    ...
                                    <input type="hidden" class="form-control" id="type" name="type" value="13">
                                ...
                                <form class="col-sm-2 control-label" action="bh31_ferias.jsp" method="post">
                                    ...
                                    <input type="hidden" class="form-control" id="typeferias" name="typeferias" value="3">
