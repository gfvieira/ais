...
<%Servidor_model servidor = (Servidor_model) request.getAttribute("oficial");
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" action="AttPessoal.jsp" method="post">
                                <h3 class="centered"><i class="fa fa-angle-double-right"></i><b> Atualização de Oficial</b></h3><br><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" size="1" name="quadro" required>
                                            ...
                                            <%if (servidor.getQuadro().equals("QC")) {%><option value="QC">QC-IM</option><%}%>                                            <%if (servidor.getQuadro().equals("CPA")) {%><option value="CPA">CPA</option><%}%>
                                            <%if (servidor.getQuadro().equals("AA")) {%><option value="AA">AA</option><%}%>
                                            <%if (servidor.getQuadro().equals("CD")) {%><option value="CD">CD</option><%}%>
                                            <%if (servidor.getQuadro().equals("EN")) {%><option value="EN">EN</option><%}%>                                            <%if (servidor.getQuadro().equals("CPA")) {%><option value="CPA">CPA</option><%}%>
                                            <%if (servidor.getQuadro().equals("RM2-T")) {%><option value="RM2-T">RM2-T</option><%}%>
                                            <%if (servidor.getQuadro().equals("RM2-MD")) {%><option value="RM2-MD">RM2-MD</option><%}%>
                                            <%if (servidor.getQuadro().equals("RM2-CD")) {%><option value="RM2-CD">RM2-CD</option><%}%>
                                            <%if (servidor.getQuadro().equals("RM2-EN")) {%><option value="RM2-EN">RM2-EN</option><%}%>
                                            <%if (servidor.getQuadro().equals("RM2-S")) {%><option value="RM2-S">RM2-S</option><%}%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"> 
                                        <%String data2 = String.valueOf(servidor.getPromo());%>
                                        <input name="promo" id="promo" type="date" class="form-control" required="" min="1910-01-01" max="2016-01-01" value="<%out.print(data2);%>">
                                    </div> 
