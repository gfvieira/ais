                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" action="AttPessoal.jsp" method="post">
                                <h3 class="centered"><i class="fa fa-angle-double-right"></i><b> Atualização de Civil</b></h3><br><br>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Assemelhado:</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="os" name="os" value="<%out.print(servidor.getOs());%>">
                                    </div>
                                ...
                                <input type="hidden" class="form-control" id="type" name="type" value="4">
