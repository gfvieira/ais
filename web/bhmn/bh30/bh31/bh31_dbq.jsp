...
String nip_dbq = request.getParameter("dbq");%>
                ...
                <section class="wrapper">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" action="DBQPessoal.jsp" method="post">
                                <h3 class="centered"><i class="fa fa-angle-double-right"></i><b> Férias</b></h3><br><br>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Data de Desembarque</label>
                                    <div class="col-sm-3"> 
                                        <input name="dbq" id="dbq" type="date" class="form-control" required="" min="1910-01-01" max="2016-01-01">
                                    </div>
                                </div>
                                <input type="hidden" class="form-control" id="user" name="user" value="<%out.print(usuario.getNip());%>">
                                <input type="hidden" class="form-control" id="nip" name="nip" value="<%out.print(nip_dbq);%>">
