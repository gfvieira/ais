...
<%Servidor_model servidor = (Servidor_model) request.getAttribute("oficial");
    ArrayList<Servidor_movi> servidorarray = (ArrayList<Servidor_movi>) request.getAttribute("oficialarray");
                        ...
                        <div class="col-md-12 mt" style="margin-top: 5px">
                            <div class="form-panel">
                                ...
                                <form class="col-sm-2 control-label" action="bh31_ferias.jsp" method="post">
                                    ...
                                    <input type="hidden" class="form-control" id="typeferias" name="typeferias" value="2">
