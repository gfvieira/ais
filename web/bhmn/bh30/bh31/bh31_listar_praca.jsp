                    ...
                    <div class="col-md-12 mt">
                        <div class="content-panel">
                            <table class="table table-hover">
                                ...
                                <%} else {%>
                                <h2 class="centered"><%out.print(list.size());%> Militar(es) Encontrado(s):</h2>
                                <%}%>
                                <hr>
                                <thead>
                                    <tr>
                                        <th><i class="fa fa-angle-double-right text-center"></i> Graduação</th>
                                ...
                                <%switch (servidor.getGrad()) {
                                    case 1:%><i class="center-block"></i><td>MN-RC</td>
                                <%break;
                                    case 2:%><i class="center-block"></i><td>MN</td>
                                <%break;
                                    case 3:%><i class="center-block"></i><td>MNE</td>
                                <%break;
                                ...
                                <td><i class="center-block"></i><%out.print(servidor.getQuadro());%></td>
