                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <%if (temp != null) {
                                        if (temp.equals("OK1")) {%>
                                <div class="alert alert-success centered"><b>Concluido!</b> O Host foi cadastrado com sucesso.</div>
                                <%} else if (temp.equals("OK2")) {%>
                                <div class="alert alert-success centered"><b>Concluido!</b> O Host foi atualizado com sucesso.</div>
                                <%} else {%>
