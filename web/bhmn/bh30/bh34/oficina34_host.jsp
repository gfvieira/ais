                    ...
                    <div class="col-md-12 mt">
                        <div class="content-panel">
                            <table class="table table-hover">
                                ...
                                <%} else {%>
                                <h2 class="centered"><%out.println(list.size());%> IP(s) Cadastrado(s):</h2>
                                <%}%>
                                <hr>
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fa fa-angle-double-right text-center"></i> Mac Address</th>                                 
                                        <th><i class="fa fa-angle-double-right text-center"></i> Setor</th>
                                        <th><i class="fa fa-angle-double-right text-center"></i> Tipo de Host</th>
                                        <th><i class="fa fa-angle-double-right text-center"></i> Sistema Operacional</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <%for (Host_model host : list) {%>
                                    <tr>
                                        <td><%out.println(host.getNome());%></td>
                                        <td><%out.println(host.getIp());%></td>
                                        <td><%out.println(host.getMac());%></td>
                                        <td><%out.println(host.getSetor());%></td>
                                        <td><%out.println(host.getTipo());%></td>
                                        <td><%out.println(host.getSo());%></td>
                                        <%if (qntd == 0) {%>
                                        <%} else {%>
                                        <td>
                                            <form class="col-sm-2 control-label" action="Hosts.jsp" method="post">      
                                                <input type="hidden" class="form-control" id="ip" name="ip" value="<% out.print(host.getIp()); %>" > 
                                                <input type="hidden" class="form-control" id="hostname" name="hostname" value="EXIBIR" > 
                                                <button type="submit" title="EXIBIR DADOS DO HOST" class="btn btn-success btn-xs"><i class="fa fa-check"></i></button>
                                            </form>
                                            <form class="col-sm-2 control-label" action="AlterarIp.jsp" method="post">      
                                                <button type="submit" title="ALTERAR DADOS DO HOST" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                                                <input type="hidden" class="form-control" id="ip" name="ip" value="<% out.print(host.getIp()); %>" > 
