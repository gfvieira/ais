                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h3 class="mb"><i class="fa fa-angle-double-right"></i> <b>Cadastro de Crachas</b></h3><br>
                                <%if (temp != null) {
                                        if (temp.equals("OK1")) {%>
                                ...
                                <form class="form-horizontal style-form" action="Cad_Identi.jsp" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 col-sm-2 control-label">Numero do crachá</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="cra" name="cra" required="">
                                        </div>
                                    </div>
