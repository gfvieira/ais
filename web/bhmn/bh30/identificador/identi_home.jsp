...
<%Usuario usuario = (Usuario) session.getAttribute("usuario");
    int cracha = (Integer) request.getAttribute("cracha");
    int estacionamento = (Integer) request.getAttribute("estacionamento");
    double qntd = cracha + estacionamento;
                                ...
                                <div class="col-lg-10 main-chart">
                                    <div class="content-panel">		
                                        ...
                                        <div class="border-head">
                                            <h3>IDENTIFICAÇÃO || DIVISÃO DE SEGURANÇA</h3>
                                        </div>
                                        <div class="custom-bar-chart">
                                            ...
                                            <div class="bar" style="margin: 0px 20%;">
                                                <div class="title">CRACHÁ</div>
                                                <div class="value tooltips" data-original-title="<%out.print(cracha);%>" data-toggle="tooltip" data-placement="top"><%out.print((cracha * 100) / qntd);%>%</div>
                                            </div>
                                            <div class="bar" style="margin: 0px 20%;">
                                                <div class="title" style=" left:-30px">ESTACIONAMENTO</div>
                                                <div class="value tooltips" data-original-title="<%out.print(estacionamento);%>" data-toggle="tooltip" data-placement="top"><%out.print((estacionamento * 100) / qntd);%>%</div>
                                            </div>
                                        </div>
                                    </div><!-- /row -->
                                </div>
