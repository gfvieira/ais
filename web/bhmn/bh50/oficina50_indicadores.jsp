                ...
                <section class="wrapper">
                    ...
                    <div class="row mt">
                        <%if ((usuario.getTypeAccess().equals("ELETRICA")
                                    ...
                                    || usuario.getTypeAccess().equals("TOTAL")) && el != null) {%>
                        ...
                        <%}
                            if ((usuario.getTypeAccess().equals("REFRIGERACAO")
                                    || usuario.getTypeAccess().equals("ENCARREGADOBH52")
                                    || usuario.getTypeAccess().equals("CHEFEBH50")
                                    || usuario.getTypeAccess().equals("TOTAL")) && mo != null) {%>
                        <div class="col-lg-10 main-chart">
                            <div class="content-panel">		
                                <!--CUSTOM CHART START -->
                                <div class="border-head">
                    ...
                    <div class="row mt">
                        <%if ((usuario.getTypeAccess().equals("CARPINTARIA")
                                    || usuario.getTypeAccess().equals("ENCARREGADOBH52")
                                    || usuario.getTypeAccess().equals("CHEFEBH50")
                                    || usuario.getTypeAccess().equals("TOTAL")) && cp != null) {%>
                        <div class="col-lg-10 main-chart">
                            <div class="content-panel">		
                                <!--CUSTOM CHART START -->
                                <div class="border-head">
                        ...
                        <%}
                            if ((usuario.getTypeAccess().equals("METALURGIA")
                                    || usuario.getTypeAccess().equals("ENCARREGADOBH52")
                                    || usuario.getTypeAccess().equals("CHEFEBH50")
                                    || usuario.getTypeAccess().equals("TOTAL")) && mt != null) {%>
                        <div class="col-lg-10 main-chart">
                            <div class="content-panel">		
                                <!--CUSTOM CHART START -->
                                <div class="border-head">
                    ...
                    <div class="row mt">
                        <%if ((usuario.getTypeAccess().equals("PREFEITURA")
                                    || usuario.getTypeAccess().equals("ENCARREGADOBH52")
                                    || usuario.getTypeAccess().equals("CHEFEBH50")
                                    || usuario.getTypeAccess().equals("TOTAL")) && prefe != null) {%>
                        <div class="col-lg-10 main-chart">
                            <div class="content-panel">		
                                <!--CUSTOM CHART START -->
                                <div class="border-head">
                        ...
                        <%}
                            if ((usuario.getTypeAccess().equals("AGUADA")
                                    || usuario.getTypeAccess().equals("ENCARREGADOBH52")
                                    || usuario.getTypeAccess().equals("CHEFEBH50")
                                    || usuario.getTypeAccess().equals("TOTAL")) && cav != null) {%>
                        <div class="col-lg-10 main-chart">
                            <div class="content-panel">		
                                <!--CUSTOM CHART START -->
                                <div class="border-head">
                    ...
                    <div class="row mt">
                        <%if ((usuario.getTypeAccess().equals("GARAGEM")
                                    || usuario.getTypeAccess().equals("ENCARREGADOBH53")
                                    || usuario.getTypeAccess().equals("CHEFEBH50")
                                    || usuario.getTypeAccess().equals("TOTAL")) && moto != null) {%>
                        <div class="col-lg-10 main-chart">
                            <div class="content-panel">		
                                <!--CUSTOM CHART START -->
                                <div class="border-head">
