                        ...
                        <div class="col-lg-12 main-chart">
                            <div class="content-panel">		
                                ...
                                <div class="border-head">
                                    <h3>BH-52 | Indicador de Atendimento da Oficina de Refrigeração – IAOR </h3>
                                ...
                                <div class="custom-bar-chart">
                                    ...
                                    <%for (Indicador_model_anual sate : sateAnual) {
                                            if (sate.getOficina().equals("REFRIGERACAO")) {
                                                String mesInd = "";
                                                ...
                                                if (temp1 == 0) {
                                                    temp1 = 2; %>  
                                    <div class="bar" style="width: 4%; margin: 0px 2%; margin-left: 50px;">
                                        <%} else {%>
                                        <div class="bar" style="width: 4%; margin: 0px 2%;">
                                            <%}
                                                if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) >= 0.9) {%>
                                            <div class="title" style="color: blue; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                                            <div class="value tooltips" data-original-title="<%out.print(df.format(sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) * 100));%>" data-toggle="tooltip" data-placement="top" style="background: blue"><%out.print(sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) * 100);%>%</div>
                                            <%} else {%>
                                            <div class="title" style="color: red; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                                        ...
                                        <tr>
                                            <%for (Indicador_model_anual sate : sateAnual) {
                                                    if (sate.getOficina().equals("REFRIGERACAO")) {
                                                        ...
                                                        if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) >= 0.9) {%> 
                                            <th style="color: blue; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></th>
                                                <%} else {%>
                                            <th style="color: red; font-size: 10px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></th>
                                                <%}
                                                        }
                                                    }%>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <%for (Indicador_model_anual sate : sateAnual) {
                                                    if (sate.getOficina().equals("REFRIGERACAO")) {
                                                        if (sate.getTotalFechado() / (sate.getTotalAberto() + sate.getTotalFechado()) >= 0.9) {%> 
                                            <td style="color: blue;"><%out.print(df2.format(sate.getTotalFechado()));%>/<%out.print(df2.format(sate.getTotalFechado()+(sate.getTotalAberto())));%></td>
                                            <%} else if (sate.getTotalAberto() + sate.getTotalFechado() == 0) {%>
                                            <td style="color: red;">0</td>
                                            <% } else {%>
                                            <td style="color: red;"><%out.print(df2.format(sate.getTotalFechado()));%>/<%out.print(df2.format(sate.getTotalFechado()+(sate.getTotalAberto())));%></td>
                                            <%}
                                                    }
                                                }
                                            %>
