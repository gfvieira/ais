            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%out.println(sate.getPost());%>-<%out.println(sate.getNome());%></td>
                        ...
                        <td><span class="label label-success label-mini"><%out.println(sate.getStatus());%></span></td>
                            <%}%>
                        <td>
                            <form class="col-sm-2 control-label" action="ConsultOs.jsp" method="post">      
                                <button type="submit" title="EXIBIR DADOS DA OS" class="btn btn-success btn-xs"><i class="fa fa-check"></i></button>
                                <input type="hidden" class="form-control" id="os" name="os" maxlength="50" value="<% out.print(sate.getOs()); %>" > 
                            </form>
                        </td>
                    </tr>
                    <% }%>
