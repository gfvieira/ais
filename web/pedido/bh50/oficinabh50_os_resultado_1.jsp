            ...
            <div class="row"><br> 
                ...
                <div class="col-lg-12">
                    <div class="form-panel center-block">
                        <h3 class="mb"><i class="fa fa-angle-double-right"></i> <b><i>Serviço de Atendimento das Oficina do BH-50</i> </h3><br><br>
                    ...
                    <div class="form-panel">
                        <form class="form-horizontal style-form" action="">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <p class="form-control-static" style="text-align: left;"><%out.println(oficina.getNome());%></p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 col-sm-2 control-label">Hora do Evento:</label>
                                <div class="col-sm-3">
